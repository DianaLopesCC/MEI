...
public class Bike_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uMer.Bike"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Bike_ESTest_scaffolding.class.getClassLoader() ,
      "uMer.Trip",
      "uMer.Vehicle",
      "uMer.Bike"
    );
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Bike_ESTest_scaffolding.class.getClassLoader()); 
