...
public class Van_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uMer.Van"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Van_ESTest_scaffolding.class.getClassLoader() ,
      "uMer.Trip",
      "uMer.Van",
      "uMer.Vehicle"
    );
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Van_ESTest_scaffolding.class.getClassLoader()); 
